...
def generate_launch_description():
    ...
    declare_x_arg = DeclareLaunchArgument('x', default_value='1.9')
    declare_y_arg = DeclareLaunchArgument('y', default_value='2.5')
    ...
    obstacle_avoidance_node = Node(
            ...
            parameters=[
                ...
                {'wall_dist_target': 0.30},        # Distancia ideal para costear la pared derecha
            ],
        )
