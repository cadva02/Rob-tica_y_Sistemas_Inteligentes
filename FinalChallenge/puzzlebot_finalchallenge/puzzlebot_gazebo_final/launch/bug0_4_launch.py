...
def generate_launch_description():
    ...
    declare_world_arg = DeclareLaunchArgument(
        'world', default_value='obstacle_avoidance_4.world',
    ...
    declare_x_arg = DeclareLaunchArgument('x', default_value='-1.6')
    declare_y_arg = DeclareLaunchArgument('y', default_value='3.5')
    ...
    pkg = get_package_share_directory('puzzlebot_gazebo_final')
    ...
    obstacle_avoidance_node = Node(
            ...
            parameters=[
                ...
                {'yaw_tolerance': 0.25},
                {'obstacle_distance': 0.35},       # Umbral frontal para detectar el muro
                {'front_angle': 40.0},             # Cono de visión frontal (30 grados)
                {'scan_topic': 'scan'},
