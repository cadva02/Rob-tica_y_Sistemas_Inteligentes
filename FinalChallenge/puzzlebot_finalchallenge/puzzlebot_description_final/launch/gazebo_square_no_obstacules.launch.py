...
def generate_launch_description():
    ...
    declare_world_arg = DeclareLaunchArgument(
        ...
        description='Gazebo world with real ArUco markers'
    )
    ...
    declare_marker_map_arg = DeclareLaunchArgument(
        ...
        default_value=json.dumps([
            {'id': 0, 'x': 2.5, 'y': -0.5, 'theta': 3.141592654},
            {'id': 1, 'x': 2.5, 'y': 2.5, 'theta': 4.7123},
            {'id': 2, 'x': -0.5, 'y': 2.5, 'theta': 0.0},
            {'id': 3, 'x': -0.5, 'y': -0.5, 'theta': 1.5708},
        ]),
    ...
    localization_node = Node(
        ...
        parameters=[{
            ...
            'sigma_obs_x': 0.20,
            'sigma_obs_y': 0.10,
            'sigma_obs_theta': 1.70,
            'aruco_distance_gain': 0.6,
            'aruco_theta_distance_gain': 0.6,
    ...
    setpoint_generator_node = Node(
        ...
        parameters=[{
            ...
            'custom_waypoints_json': json.dumps([
                ...
                {'x': 2.0, 'y': 0.0, 'theta': 1.5707963267948966},
                {'x': 2.0, 'y': 2.0, 'theta': 3.141592653589793},
                {'x': 0.0, 'y': 2.0, 'theta': -1.5707963267948966},
                {'x': 0.0, 'y': 0.0, 'theta': 0.0},
            ]),
        }],
    )
